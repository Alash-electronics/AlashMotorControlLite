...
- ✅ **Двуязычная документация** - English and Русский
...
> 💡 **Примечание:** Все примеры доступны на английском и русском языках. Ищите файлы с суффиксом `_ru` для русской версии.
...
### Version 1.0.9
- ✅ Библиотека поддерживает оба языка (English/Русский)
- ✅ Все примеры доступны на двух языках
