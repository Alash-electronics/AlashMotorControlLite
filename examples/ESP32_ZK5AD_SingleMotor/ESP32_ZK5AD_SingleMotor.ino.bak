...
void setup() {
  Serial.begin(115200);
  Serial.println("ESP32 + ZK-5AD Motor Control");
...
void loop() {
  ...
  Serial.println("Мотор вперед на 50%");
  motor.setSpeed(50);
  delay(2000);

  // Вращение вперед на полной скорости
  Serial.println("Мотор вперед на 100%");
  motor.setSpeed(100);
  delay(2000);
  ...
  Serial.println("Мотор назад на 50%");
  motor.setSpeed(-50);
  delay(2000);

  // Вращение назад на полной скорости
  Serial.println("Мотор назад на 100%");
  motor.setSpeed(-100);
  delay(2000);

  // Торможение мотора
  Serial.println("Торможение мотора");
  motor.brake();
  delay(2000);
}
